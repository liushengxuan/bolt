...
class ReaderBase {
 public:
  ...
  const std::shared_ptr<decryption::ParquetFileDcryptor> fileDecryptor() const {
 ...
 private:
  ...
  std::string HandleAadPrefix(
      const std::shared_ptr<arrow::FileDecryptionProperties>&
  ...
  std::shared_ptr<arrow::FileDecryptionProperties>
      fileDecryptionProperties_;
  std::shared_ptr<decryption::ParquetFileDcryptor> fileDecryptor_;
};
...
uint32_t ReaderBase::ParseMetaDataOfEncryptedFileWithEncryptedFooter(
  ...
  fileDecryptor_ = std::make_shared<decryption::ParquetFileDcryptor>(
...
std::string ReaderBase::HandleAadPrefix(
  ...
  if (fileHasAadPrefix) {
    ...
    const std::shared_ptr<arrow::AADPrefixVerifier>& aadPrefixVerifier =
